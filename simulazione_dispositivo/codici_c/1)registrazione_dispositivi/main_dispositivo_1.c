...
int main() {
    ...
    write_string_to_file(DISPOSITIVO_1_PATH"my_id.puf", registrazionePairs[2].value);
  
    write_string_to_file(DISPOSITIVO_1_PATH"my_helper_data.puf", registrazionePairs[3].value);
